...
public class NumbersActivity extends AppCompatActivity {
    ...
    //declare media player object to play word audio
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("one", "lutty", R.drawable.number_one, R.raw.number_one));
        ...
        //setting onClickListener for particular word and listen to audio file
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> peren, View view, int position, long id) {
                //getting posistion of particular word
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mPlayer = MediaPlayer.create(NumbersActivity.this, word.getmAudioResourceId());
